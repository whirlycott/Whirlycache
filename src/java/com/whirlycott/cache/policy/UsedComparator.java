...
/**
 * A comparison function, used by LRUMaintenancePolicy, which determines whether
 * one Item has been used more recently than a second Item, using said Items'
 * used properties.
 * 
...
public class UsedComparator implements Comparator {
	...
	private static final Logger log = Logger.getLogger(UsedComparator.class);
